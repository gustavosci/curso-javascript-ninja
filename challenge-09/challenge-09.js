...
*/
    ...
    */
    function calculator(x, y) {
        function otherCalculator(callback){
            return callback(x, y)
        }
    ...
    */
    var subtraction = calculator(5, 70);
    var multiplication = calculator(5, 70);
    var division = calculator(5, 70);
    var mod = calculator(5, 70);
    ...
    */
    ...
    console.log( 'O resultado do módulo é:', mod(function (x, y){
        return x % y;
    }) );
