...
desafio.
*/
var teams = ["Inter", "Caxias", "Veranópolis", "São José", "Greminho"];
...
function showTeamPosition (pos) {
    ...
    if (pos < 1 || pos > 5){
        return ("Posição inválida. O campeonato tem apenas 5 times!");
    }
    // Retorna o time em questão
