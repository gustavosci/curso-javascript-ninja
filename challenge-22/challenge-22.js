...
(function(doc){
    ...
    */
    ...
    var person1 = new Person("Gustavo", "Santos");
    var person2 = new Person("Daniela", "Morais");
    ...
    */
    function sum(){
      ...
      var result = Array.prototype.reduce.call(arguments, function(acumulado, numero){
