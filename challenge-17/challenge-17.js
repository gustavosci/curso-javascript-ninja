(function(){
	...
	*/
	...
	console.log( text.replace(/(Manuel Marques de Sousa)/g, "Gustavo Luis Silva dos Santos") );
	/*
	...
	*/
	...
	console.log( text.replace(/(brasileiro)/g, "sapiranguense") );
	...
	*/
	...
	console o resultado.
	*/
	function replaceDate(capturaTotal, dia, d1, mes, d2, ano){
